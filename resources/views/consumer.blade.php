...
<script async defer crossorigin="anonymous"
        src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v10.0&appId=296219948132208&autoLogAppEvents=1"
        nonce="n9p8sKaB"></script>
...
<section class="work-category pad-tb">
    <div class="container">
        ...
        <div class="row mt30">
            <div class="col-lg-3 col-sm-6 col-6 wow fadeIn" data-wow-delay="0.1s"><a href="consumer">
            ...
            <div class="col-lg-3 col-sm-6 col-6 wow fadeIn" data-wow-delay="0.3s"><a href="billers">
                    <div class="industry-workfor hoshd"><img src="images/icons/travel-case.svg" alt="img"> <h6><font
                                color="#012480">Consumer Web Portal</font></h6></div>
                </a></div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-5 mt30 h-scl-">
                <div class="img-ca2set h-scl-base"><a href="https://www.instagram.com/p/CBkZjZYAVjs/"><img
            ...
            <div class="col-lg-7 mt30 h-scl-">
                <div class="img-ca2set h-scl-base"><a
                        href="https://www.facebook.com/directpay.srilanka/posts/791578108066225"><img
                            src="images/about/office-3.jpg" alt="companyname" class="img-fluid"></a></div>
            </div>
            <div class="col-lg-5 mt30 h-scl-">
                <div class="img-ca2set h-scl-base">
                    <div class="fb-post" data-href="https://www.facebook.com/directpay.srilanka/posts/859784407912261"
                         data-width="470" data-show-text="false">
                        <blockquote cite="https://www.facebook.com/directpay.srilanka/posts/859784407912261"
                                    class="fb-xfbml-parse-ignore"><p>We are excited beyond words can express!
                                .
                                DirectPay just became the 𝗡𝗮𝘁𝗶𝗼𝗻𝗮𝗹 𝗪𝗶𝗻𝗻𝗲𝗿 of the “𝗕𝗲𝘀𝘁
                                𝗗𝗶𝘀𝗿𝘂𝗽𝘁𝗼𝗿” award and...</p>Posted by <a
                                href="https://www.facebook.com/directpay.srilanka/">DirectPay</a> on&nbsp;<a
                                href="https://www.facebook.com/directpay.srilanka/posts/859784407912261">Tuesday, 30
