...
<head>
    <meta charset="utf-8"/>
    <title>White lable - DirectPay</title>
        ...
        <div class="row">
            <div class="col-lg-6 v-center">
                <div class="img-block hover-scale mt0 m-mb30">
                    <img src="images/about/white.png" alt="about" class="img-fluid upset"/>
                    ...
                    <div class="weworkfor pt20 pb20">
                        <div class="container">
                            <div class="logo-weworkfor owl-carousel">
                                <div class="items"><img src="images/client/clients-14.png" alt="DirectPay Clients"
                                                        class="img100w"></div>
                                <div class="items"><img src="images/client/clients-8.png" alt="DirectPay Clients"
                                                        class="img100w"></div>
                                <div class="items"><img src="images/client/clients-2.png" alt="DirectPay Clients"
                                                        class="img100w"></div>
                                <div class="items"><img src="images/client/clients-15.png" alt="DirectPay Clients"
                                                        class="img100w"></div>
                                <div class="items"><img src="images/client/clients-16.png" alt="DirectPay Clients"
                                                        class="img100w"></div>
                                <div class="items"><img src="images/client/clients-17.png" alt="DirectPay Clients"
                                                        class="img100w"></div>
        ...
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-lg-4 col-sm-6  ftr-brand-pp">
                    <a class="navbar-brand mb30 mt30" href="#"> <img src="images/white-logo-b.png" alt="Logo"
                                                                     width="140"/></a>
                    <p>DirectPay is the solution to facilitate low value transactions via Clearing House using smart
                        phones between customers and merchants eliminating high cost to third party payment verification
                        agencies and expensive equipment.</p>
                ...
                <div class="col-lg-3 col-sm-6">
                    ...
                    <ul class="footer-address-list ftr-details">
                        ...
                        <li>
                            ...
                            <p>Phone <span> <a
                                        href="tel:+94 772 448 144">(+94) 772 448 144 | (+94) 712 083 911</a></span></p>
                        </li>
                        <li>
