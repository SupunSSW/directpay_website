...
<head>
    ...
    <meta name="description" content="DirectPay won the Merit Award at the Asia Smart App (ASA) Awards 2020!">
    <meta name="keywords" content="ASA 2021, DirectPay won ASA 2021">
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="blog-header">
                    <h2>DirectPay won the Merit Award at the Asia Smart App (ASA) Awards 2020!</h2>
                    <div class="row mt20 mb20">
                        <div class="col-md-8 col-9">
                            <div class="media">
                                <div class="user-image bdr-radius"><img src="images/user-thumb/directpay.jpg" alt="girl"
                                                                        class="img-fluid"/></div>
                                <div class="media-body user-info">
                                    <h5>By DirectPay</h5>
                                    <p>Monday, 17 September 2020</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-3">
                            <div class="postwatch"><i class="far fa-eye"></i> 96</div>
                        </div>
                    </div>
                </div>
                <div class="image-set"><img src="images/blog/blog-post-9.jpg" alt="blog images" class="img-fluid"/>
                </div>
                <div class="blog-content mt30">
                    <p>
                        We are the only Sri Lankan app to be recognized at the ceremony with a Merit Award among all the
                        Asian apps. WTIA organized the ASA Ceremony for the 7th consecutive year, to further encourage
                        the development of the expanding smart application industry and DirectPay is proud to have had
                        the honour of being a part of it!
                    </p><br/>


                    <p>
                        Thanks to the amazing team behind DirectPay including our Co-Founder/COO, Sasindu Pathiranage
                        for taking part in the Award Presentation Ceremony. We thank everyone who supported us in
                        breaking the boundaries in every way with #DirectPay!
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 mt30 mb30">
                            <div class="blog-post-tag">
                                ...
                                <a href="https://www.facebook.com/directpay.srilanka/posts/737308430159860">Visit
                                    Directpay Article</a>
