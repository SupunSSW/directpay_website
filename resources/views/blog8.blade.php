...
<head>
    ...
    <meta name="description" content="We are still overjoyed by winning 3 awards at the National ICT Awards (NBQSA) 2020 and being
                        selected to represent Sri Lanka at APICTA in Malaysia.">
    <meta name="keywords" content="NBQSA 2020, DirectPay">
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="blog-header">
                    <h2>DirectPay Wins 3 awards at the National ICT Awards (NBQSA) 2020.</h2>
                    <div class="row mt20 mb20">
                        <div class="col-md-8 col-9">
                            <div class="media">
                                <div class="user-image bdr-radius"><img src="images/user-thumb/directpay.jpg"
                                                                        alt="DirectPay" class="img-fluid"/></div>
                                <div class="media-body user-info">
                                    <h5>By DirectPay</h5>
                                    <p>Wednesday, 10 February 2021</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-3">
                            <div class="postwatch"><i class="far fa-eye"></i> 357</div>
                        </div>
                    </div>
                </div>
                <div class="image-set"><img src="images/blog/blog-post-8.jpg" alt="blog images" class="img-fluid"/>
                </div>
                <div class="blog-content mt30">
                    <p>
                        We are still overjoyed by winning 3 awards at the National ICT Awards (NBQSA) 2020 and being
                        selected to represent Sri Lanka at APICTA in Malaysia.
                    </p>
                    <br/>
                    <p>
                        1. Silver Award for DirectPay Smart POS<br/>
                        2. Bronze Award for Internet Payment Gateway (IPG)<br/>
                        3. Merit Award for DirectPay Virtual POS<br/>

                    </p>
                    <br/>
                    <p>
                        The APICTA Awards is the largest IT competition in the Asia Pacific Region organized in order to
                        bring awareness on ICT among the community and assist in bridging the digital divide. In 2018,
                        DirectPay represented Sri Lanka at APICTA in China and won a gold award in the Consumer - Wealth
                        and Retail Category by competing with 14 other countries in the Asia Pacific region.
                    </p>
                    <br/>
                    <p>
                        A massive shout out to our team for their dedication and hard work that was put into gaining
                        this achievement.
                    </p>
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 mt30 mb30">
                            <div class="blog-post-tag">
                                <span>Read DirectPay</span>
                                <a href="https://www.facebook.com/directpay.srilanka/posts/833210827236286">Visit
                                    Article</a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 mt30 mb30">
                            <div class="post-navigation text-left ">
                                <span><a href="blog4">Prev Post</a></span>
                        ...
                        <div class="col-lg-6 col-md-6 mt30 mb30">
                            <div class="post-navigation text-left text-md-right">
                                <span><a href="blog">Next Post</a></span>
            ...
            <div class="col-lg-4">
                <div class="sidebar">
                    ...
                    <div class="recent-post widgets mt60">
                        ...
                        <div class="media">
                            <div class="post-image bdr-radius">
                                <a href="blog"><img src="images/blog/blog-small2.jpg" alt="girl" class="img-fluid"/></a>
                            </div>
                            <div class="media-body post-info">
                        ...
                        <div class="media">
                            <div class="post-image bdr-radius">
                                <a href="blog2"><img src="images/blog/blog-small.jpg" alt="girl" class="img-fluid"/></a>
                            </div>
                            <div class="media-body post-info">
                                <h5><a href="blog2">The Fintech Revolution Begins in Sri Lanka</a></h5>
                                <p>May 21, 2018</p>
                            </div>
                        </div>
                    </div>
