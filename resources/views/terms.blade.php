...
<head>
    ...
    <meta name="description" content="DirectPay hereby appoints the Merchant and the Merchant accepts the appointment as a merchant of
                    DirectPay Service.">
    <meta name="keywords" content="DirectPay Terms and Conditions">
    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="common-heading-2 text-l">
                ...
                <center>
                    <h2 class="mb30"><font color="#333"><h1>Terms &amp; Conditions</h1></font></h2>
                </center>
                <br>
            </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-10">
                ...
                <p>DirectPay hereby appoints the Merchant and the Merchant accepts the appointment as a merchant of
                    DirectPay Service.</p>
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>SCOPE OF THE AGREEMENT</li>
                </ul>
                <p>The purpose of this Agreement is to record the terms and conditions and the rights and obligations of
                    ...
                    DirectPay Merchants to accept such payments made by the customers via the DirectPay.</p>
                <p>&nbsp;</p>
                <ol class="list-ol ol-liin" start="2">
                    <li>WARRANTIES AND REPRESENTATIONS
                        <ul class="list-style-">
                            <li>Merchant hereby warrants and represents for the benefit of DirectPay that on the date of
                                this Agreement and throughout the term:
                                <ul class="list-style-">
                                    <li>Any and all, information and the deliverables enumerated herein do not and shall
                                        not:
                                    </li>
                                </ul>
                            </li>
                ...
                <ol class="list-ol ol-liin">
                    ...
                    <li>Be illegal, and shall ensure to hold any requisite licenses, permits and/or ownership documents
                        where necessary;
                    </li>
                ...
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>Merchant Networks and its employees are suitably qualified and competent to undertake the
                        responsibilities enumerated herein in accordance with the terms of this Agreement;
                    </li>
                </ul>
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>Neither DirectPay nor any of its suppliers makes any representations or warranties, express or
                ...
                <ol class="list-ol ol-liin" start="3">
                    <li>CHARGES / PAYMENT PROCESS
                        <ul class="list-style-">
                            <li>The Merchant shall pay DirectPay a Commission Rate at the rate set out in the Annexure 1
                                each transaction based on the set table for each transaction (“Transaction”) facilitated
                                through the DirectPay system.
                            </li>
                            <li>The Commission Rate shall be retained fully by DirectPay and the due amount shared by
                                the merchant shall be transferred to the registered bank account given in the
                                application.
                            </li>
                            <li>The Merchant agrees that DirectPay shall have the right to revise the Commission Rate
                ...
                <ul class="list-style-">
                    <li>SETTLEMENT
                        <ol class="list-ol ol-liin">
                            ...
                            <li>A monthly as well as a daily report shall be generated by DirectPay system to the
                                merchant portal to monitor their transactions.
                            </li>
                            <li>Settlement of daily Transactions shall occur in real time via LankaCLear CEFTS system.
                            </li>
                        </ol>
                    </li>
                </ul>
                ...
                <ol class="list-ol ol-liin" start="4">
                    <li>RETURNED ITEMS/CHARGEBACKS
                        <ul class="list-style-">
                            <li>If:
                                <ol>
                                    <li>A customer disputes any transaction or payment for any transaction (irrespective
                                        of the nature or manner of such disputes);
                                    </li>
                                    <li>A transaction is charged back to DirectPay for any reason by the issuing finance
                                    ...
                                    <li>DirectPay has any reason to believe a Transaction previously submitted hereunder
                                        is unlawful, unenforceable, irregular, questionable, not genuine, or is
                                        otherwise unacceptable; and/or
                                    </li>
                                    <li>Any other event or circumstance, which DirectPay shall have previously notified
                ...
                <p>At DirectPay’s request the merchant shall, repurchase such transaction(s) at the amount of such
                    ...
                    demand by DirectPay, pay DirectPay the full amount of the chargeback.</p>
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>The Merchant understands that obtaining an authorization for any Transaction shall not
                ...
                <ul class="list-style-">
                    <li>REVERSALS
                        <ol class="list-ol ol-liin">
                            <li>The Merchant shall be able to reverse a previously settled amount to the customer’s
                            ...
                            <li>The Merchant shall be able to initiate a reversal of the full amount of any Transaction
                                that has not yet been posted for settlement.
                            </li>
                            <li>For reversals via bank accounts, DIRECTPAY will direct the reversal to the respective
                                bank of the account holder.
                            </li>
                            <li>For reversals of third party banking DirectPay will direct the reversal via LankaClear
                                CEFTS system.
                            </li>
                        </ol>
                    </li>
                ...
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>RESOLUTION OF TRANSACTION DISPUTES/REVERSALS For any transaction disputes, other than network
                ...
                <ol class="list-ol ol-liin">
                    <li>Promptly honor any payment request for a Transaction by a customer via the DirectPay Service;
                    </li>
                    <li>Offer goods and/or services to customers who wish to make payments via the DirectPay Service on
                    ...
                    <li>Not require or post signs indicating that they require a minimum value for Transactions below
                ...
                <p>The Merchant shall before completing a Transaction, comply with all security procedures specified by
                    DirectPay from time to time.</p>
                <p>&nbsp;</p>
                <ul class="list-style-">
                ...
                <ol class="list-ol ol-liin">
                    ...
                    <li>Do not commit any act or omission in relation to DirectPay, which may result in a claim or
                        action against DirectPay service and/or cause any damage to the reputation, brand or image of
                        DirectPay service;
                        <ul class="list-style-">
                            <li>The Merchant shall encourage customers to make payments through the DirectPay Service
                ...
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>The Merchant shall be responsible for ensuring the security of the access credentials provided
                    ...
                    <li>The Merchant shall keep all customer information confidential and shall not use such information
                        for any other purpose except for the purpose of fulfilling its obligations under this Agreement.
                    </li>
                    <li>The Merchant agrees and accepts that all documents and directions issued by DirectPay Service
                ...
                <p>The Merchant shall prominently display in the place or places of business nominated, DirectPay
                    ...
                    or promotional material in connection with the DirectPay service.</p>
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>REPORTING</li>
                </ul>
                <p>The Merchant shall maintain reports with the full details of the Transactions concluded through
                    ...
                    detailed transaction logs maintained by DirectPay shall be final.</p>
                <p>&nbsp;</p>
                ...
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>Bank shall maintain its customer service hotline to which all enquiries from the Merchant could
                    ...
                    <li>Bank shall maintain the DirectPay in working order to facilitate the settlement of
                        Transactions.
                    </li>
                </ul>
                <p>&nbsp;</p>
                ...
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>The DirectPay is provided on an “as is” basis without representations of any kind whether
                        express or implied to the fullest extent permitted by law.
                    </li>
                </ul>
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>DirectPay shall not be liable for any loss or damages, whether direct, incidental, special, or
                ...
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>DirectPay shall not be liable for loss, damage, or delay caused by events which DirectPay cannot
                ...
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>The Merchant shall indemnify and keep DirectPay fully indemnified from and against all actions,
                ...
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>This Agreement shall be valid for a period of Three (03) Years from the Effective Date set out
                ...
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>Either Party may terminate or suspend this Agreement if the other Party breaches any of the
                ...
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>Either Party may terminate this Agreement with Thirty (30) Days written notice to the other
                        Party, without assigning any reason therefore.
                    </li>
                </ul>
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>DirectPay may immediately terminate or suspend this Agreement in the event of any violation of
                ...
                <p>&nbsp;</p>
                <ol class="list-ol ol-liin">
                    <li>Such termination or suspension shall not affect any provision of this Agreement which is
                ...
                <p>&nbsp;</p>
                <ol class="list-ol ol-liin" start="2">
                    <li>Such termination or suspension shall not prejudice the benefits provided to customers by either
                ...
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>The Merchant shall with immediate effect or within a period as notified by DirectPay or
                ...
                <p>&nbsp;</p>
                <ol class="list-ol ol-liin">
                    <li>The Merchant shall no longer hold himself out as an entity authorized by DirectPay and shall
                        cease to promote, market, advertise or operate DirectPay;
                    </li>
                </ol>
                <p>&nbsp;</p>
                <ol class="list-ol ol-liin" start="2">
                    <li>All rights granted by DirectPay to the Merchant to use the Intellectual Property pursuant to
                        this Agreement shall automatically cease;
                    </li>
                </ol>
                <p>&nbsp;</p>
                <ol class="list-ol ol-liin" start="3">
                    <li>In case of termination/suspension of this Agreement, any costs incurred by DirectPay in
                ...
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>The Merchant shall have no claim against DirectPay for indemnification or compensation, whether
                ...
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>The Parties shall settle all dues within a period of sixty (60) days from the date of
                ...
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>No Party hereto shall be deemed to be in default of any provisions hereof for any delay, failure
                ...
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>The Party receiving the Force Majeure Notice may, at its sole discretion agree with such
                ...
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>If the Force Majeure Event shall prevail for more than Thirty (30) Days, the Party receiving
                ...
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>The Merchant shall not assign all or any part of this Agreement to any other Party without prior
                ...
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>No delay, neglect or forbearance on the part of either Party in enforcing against the other
                ...
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>In the event any provision of this Agreement including those relating to any limitation of
                ...
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>This Agreement constitutes the complete agreement between the Parties hereto and supersedes all
                ...
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>Any interpretation, dispute or difference whatsoever arising between the Parties relating to
                ...
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>Unless specified otherwise, DirectPay may give notice to the Merchant by publishing on its
                ...
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>Notice shall be deemed to have been duly served upon and received by the Merchant, (a) if
                ...
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>Any notice or other communication to be given under this Agreement shall be in writing and shall
                ...
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>The Parties shall keep confidential all information including all customer information, account
                ...
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>No disclosure of any such Confidential Information shall be made to third parties without the
                ...
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>The obligation imposed on each Party under this Clause 18 shall apply during the term of this
                        Agreement and shall survive the expiration or sooner termination hereof.
                    </li>
                </ul>
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>Both Parties agree to use such Confidential Information only for matters described in this
                        Agreement.
                    </li>
                    <li>The Merchant shall obtain express written undertakings from any person to whom Confidential
                ...
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>DirectPay shall be entitled to audit the controls, security measures and/or safeguards applied
                ...
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>The Merchant can advertise, promote or publicize any matter related to DirectPay as of this
                ...
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>During the term of this Agreement, the Merchant hereby grants to DirectPay a non-exclusive,
                ...
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>During the term of this Agreement, DirectPay hereby grants to the Merchant a non-exclusive,
                ...
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>The Parties shall use the said trademarks and logos of the other Party only in the exact form
                        and style and type approved by such other Party.
                    </li>
                    <li>The Merchant shall indemnify DirectPay against any claims for the infringement of any third
                        party Intellectual Property rights arising from the use of any of the Merchant’s trademarks or
                        logos as stipulated herein.
                    </li>
                    <li>Nothing in this Agreement shall give either Party any rights, title and interest in respect of
                ...
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>Either Party shall not use in Sri Lanka any trademarks, service marks, logos or trade names so
                ...
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>Nothing in this Agreement shall be taken to create any joint venture, partnership or other
                ...
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>The Merchant agrees that DirectPay shall have the right at all times to amend these terms and
                ...
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>The Parties hereto represent and warrant to each other that their authorized signatories are
                ...
                <p>&nbsp;</p>
                <ul class="list-style-">
                    <li>Headings used in this Agreement are for reference only and shall not affect the interpretation
                        of this Agreement in any way.
                    </li>
                </ul>
                <p>IN WITNESS WHEREOF, the Parties hereto have executed this Agreement as of the Effective Date and
                    agree to be legally bound by all terms and conditions contained herein.</p>
                <p>&nbsp;</p>
