<header class="app-header navbar">
    ...
    <a class="navbar-brand" href="#">
        <img class="navbar-brand-full" src="{{ asset('img/backend/logo.png') }}" width="100" height="30"
             alt="CoreUI Logo">
        <img class="navbar-brand-minimized" src="{{ asset('img/backend/logo.png') }}" width="100" height="30"
             alt="CoreUI Logo">
    </a>
