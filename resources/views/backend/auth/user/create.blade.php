...
@section('content')
        ...
        <div class="card-body">
            ...
            <div class="row mt-4 mb-4">
                <div class="col">
                    ...
                    <div class="form-group row" id="agent-hub-cont">
                        {{ html()->label(__('validation.attributes.backend.access.users.agent_hub'))->class('col-md-2 form-control-label')->for('agent_hub') }}

                        <div class="col-md-10">
                            {{ html()->select('agent_hub', $hubs)
                            ->name('agent_hub')
                            ->class('form-control')}}
                        </div><!--col-->
                    </div><!--form-group-->
                                                            ...
                                                            <div class="checkbox d-flex align-items-center">
                                                                {{ html()->label(
                                                                        html()->checkbox('roles[]', old('roles') && in_array($role->name, old('roles')) ? true : false, $role->name)
                                                                              ->class('switch-input')
                                                                              ->id('role-'.$role->id)
                                                                              ->attribute('onchange', 'checkRole(this,'.$role->id.',"' . $role->name . '")')
    ...
    <script type="application/javascript">
        function checkRole(elem, id, role) {
            // if (role === 'agent') {
            //     if (elem.checked) {
            //         $('#agent-hub-cont').show()
            //     } else {
