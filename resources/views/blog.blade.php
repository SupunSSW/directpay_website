...
<head>
    ...
    <meta name="description" content="Seedstars World, the largest start-up competition for emerging markets and fast-growing start-up
                        scenes, brought its Sri Lanka round to a successful close during Seedstars Colombo. The event
                        took place on 25 October at Hatch, where 11 selected start-ups presented their companies in
                        front of a jury panel of experts.">
    <meta name="keywords" content="Seedstars Colombo 2018">
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="blog-header">
                    <h1>DirectPay wins Seedstars Colombo 2018</h1>
                ...
                <div class="image-set"><img src="images/blog/blog-post-1.jpg" alt="blog images" class="img-fluid"/>
                </div>
                <div class="blog-content mt30">
                    <p>
                        Seedstars World, the largest start-up competition for emerging markets and fast-growing start-up
                        scenes, brought its Sri Lanka round to a successful close during Seedstars Colombo. The event
                        took place on 25 October at Hatch, where 11 selected start-ups presented their companies in
                        front of a jury panel of experts.
                    </p>
                    ...
                    <p>
                        DirectPay won the Sri Lanka round of Seedstars World, organised by SLASSCOM. They will
                        participate at the Seedstars Asia Summit 2018, to be held in Bangkok for the second time, and at
                        Seedstars Global Summit in Switzerland, where they will have the chance to win up to $ 1 million
                        in equity investments and other prizes.
                    </p>
                    <br>
                    <p>
                        The local winner, DirectPay, a mobile payment platform that allows digital payments convenient
                        for the user by making a payment with only a ‘Click! Scan! and Pay!’ was named ‘Seedstars Best
                        Start-up in Sri Lanka’ for its innovative sustainable solution.
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 mt30 mb30">
                            <div class="blog-post-tag">
                                ...
                                <a href="http://www.ft.lk/it-telecom-tech/DirectPay-wins-Seedstars-Colombo-2018/50-665775">Visit
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 mt30 mb30">
                            <div class="post-navigation text-left text-md-right">
                                <span><a href="blog2">Next Post</a></span>
                ...
                <div class="sidebar">
                    ...
                    <div class="recent-post widgets mt60">
                        ...
                        <div class="media">
                            <div class="post-image bdr-radius">
                                <a href="blog2"><img src="images/blog/blog-small1.jpg" alt="girl"
                                                     class="img-fluid"/></a>
                            </div>
                    ...
                    <div class="recent-post widgets mt60">
                        ...
                        <div class="blog-categories">
                            <ul>
                                <li>
                                    <a href="#">Business <span class="categories-number">(6)</span></a>
                                </li>
                                <li>
                                    <a href="#">Financial <span class="categories-number">(0)</span></a>
                                </li>
                                <li>
                                    <a href="#">Awards <span class="categories-number">(0)</span></a>
                                </li>
                                <li>
                                    <a href="#">Announcements <span class="categories-number">(0)</span></a>
                                </li>
                                <li>
                                    <a href="#">Blogs <span class="categories-number">(0)</span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
