...
<head>
    ...
    <meta name="description" content="The 18th Asia Pacific ICT Alliance (APITCA) awards 2018, which was held in Guangzhou, China from
                        10 to 14 October, named DirectPay as the overall winner in the Consumer – Wealth and Retail
                        Category and Park and Pay with a Merit Award in the Start Up of the Year – Business and
                        Community Category.">
    <meta name="keywords" content="APITCA 2018, DirectPay">
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="blog-header">
                    <h1>Fintech startups make Sri Lanka proud by winning Gold and Merit awards at APICTA</h1>
                ...
                <div class="image-set"><img src="images/blog/blog-post-2.jpg" alt="blog images" class="img-fluid"/>
                </div>
                <div class="blog-content mt30">
                    <p>
                        The 18th Asia Pacific ICT Alliance (APITCA) awards 2018, which was held in Guangzhou, China from
                        10 to 14 October, named DirectPay as the overall winner in the Consumer – Wealth and Retail
                        Category and Park and Pay with a Merit Award in the Start Up of the Year – Business and
                        Community Category.
                    ...
                    <p>
                        The APICTA Awards is the largest IT competition in the Asia Pacific Region organised in order to
                        bring awareness on ICT amongst the community and assist in bridging the digital divide. The
                        award brings recognition to innovative products and solutions from ICT talents originating from
                        the Asia Pacific region.
                    </p>
                    <br>
                    <p>
                        DirectPay and Park and Pay represented Sri Lanka in a head to head battle with 14 other
                        countries in the categories and rose to the top with highest honours at the spectacular event.
                        The selection process of the nominees was based on their uniqueness, market potential, features,
                        quality, and application. Each nominee had to pitch and was rigorously assessed by a judging
                        panel of the highest calibre, making it a difficult selection process. The Gold award winning
                        product, DirectPay, is an electronic payment option providing a viable alternative to cash and
                        POS systems. It provides an entire infrastructure to facilitate payment requirements with its
                        modular based and service-oriented software architecture. Directpay enables this while
                        supporting the existing structures, allowing the merchants to offer products and services across
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 mt30 mb30">
                            <div class="blog-post-tag">
                                ...
                                <a href="http://www.ft.lk/it-telecom-tech/Fintech-startups-make-Sri-Lanka-proud-by-winning-Gold-and-Merit-awards-at-APICTA/50-665186">Visit
                    ...
                    <div class="recent-post widgets mt60">
                        ...
                        <div class="media">
                            <div class="post-image bdr-radius">
                                <a href="blog4"><img src="images/blog/blog-small.jpg" alt="girl" class="img-fluid"/></a>
                            </div>
                            <div class="media-body post-info">
                                <h5><a href="blog4">Kanishka Weeramunda Bags Two Awards At The CMI Excellence Awards</a>
                                </h5>
                                <p>23 April 2018</p>
                            </div>
                        </div>
                        <div class="media">
                            <div class="post-image bdr-radius">
                                <a href="blog5"><img src="images/blog/blog-small2.jpg" alt="girl"
                                                     class="img-fluid"/></a>
                            </div>
                            <div class="media-body post-info">
                                <h5><a href="blog5">PayMedia wins big at Disrupt Asia 2017</a></h5>
                                <p>Thursday, 3 August 2017</p>
                            </div>
                        </div>
                        <div class="media">
                            <div class="post-image bdr-radius">
                                <a href="blog6"><img src="images/blog/blog-small.jpg" alt="girl" class="img-fluid"/></a>
                            </div>
                            <div class="media-body post-info">
                                <h5><a href="blog6">PayMedia wraps up 2018 with Eleven Awards</a></h5>
                                <p>Tuesday, January 1, 2019</p>
                            </div>
                        </div>
                    </div>
                    <!--Start Recent post-->
                    ...
                    <div class="recent-post widgets mt60">
                        ...
                        <div class="blog-categories">
                            <ul>
                                ...
                                <li>
                                    <a href="#">Financial <span class="categories-number">(0)</span></a>
                                </li>
                                <li>
                                    <a href="#">Uncategorized <span class="categories-number">(0)</span></a>
                                </li>
                                <li>
                                    <a href="#">Web Design <span class="categories-number">(0)</span></a>
                                </li>
                                <li>
                                    <a href="#">WordPress <span class="categories-number">(0)</span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
