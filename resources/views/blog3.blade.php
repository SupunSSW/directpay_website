      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8">
            ...
            <div class="image-set"><img src="images/blog/blog-post-2.jpg" alt="blog images" class="img-fluid" /></div>
            <div class="blog-content mt30">
              ...
              <br>
              <p>
               DirectPay and Park and Pay represented Sri Lanka in a head to head battle with 14 other countries in the categories and rose to the top with highest honours at the spectacular event. The selection process of the nominees was based on their uniqueness, market potential, features, quality, and application. Each nominee had to pitch and was rigorously assessed by a judging panel of the highest calibre, making it a difficult selection process. The Gold award winning product, DirectPay, is an electronic payment option providing a viable alternative to cash and POS systems. It provides an entire infrastructure to facilitate payment requirements with its modular based and service-oriented software architecture. Directpay enables this while supporting the existing structures, allowing the merchants to offer products and services across all possible channels.
              ...
              <!--Start Recent post-->
                ...
                <div class="media">
                  ...
                  <div class="media-body post-info">
                    <h5><a href="blog4">Kanishka Weeramunda Bags Two Awards At The CMI Excellence Awards</a></h5>
                    <p>23 April 2018</p>
                  </div>
                </div>
                <div class="media">
                  <div class="post-image bdr-radius">
                    <a href="blog5"><img src="images/blog/blog-small2.jpg" alt="girl" class="img-fluid" /></a>
                  </div>
                  <div class="media-body post-info">
