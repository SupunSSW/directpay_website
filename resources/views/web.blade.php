...
<head>
    <meta charset="utf-8"/>
    <title>Consumer web - DirectPay</title>
        ...
        <div class="row">
            <div class="col-lg-6 v-center">
                <div class="img-block hover-scale mt0 m-mb30">
                    <img src="images/about/web.png" alt="about" class="img-fluid upset"/>
            ...
            <div class="col-lg-6">
                <div class="common-heading-2 text-l">
                    ...
                    <br><br>
                    <center><a href="billers" class="btn-main bg-btn lnk wow fadeInUp" data-wow-delay=".6s">&nbsp;&nbspPay
                            Bills&nbsp &nbsp;&nbsp;<i class="fas fa-chevron-right fa-icon"></i><span
                                class="circle"></span></a></center>
                </div>
            </div>
        </div>
    </div>
