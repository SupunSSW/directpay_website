...
<html lang="en" class="no-js">
	<head>
		<meta charset="utf-8"/>
		<title>Virtual POS - DirectPay</title>
...
<div class="col-lg-8">
	<center>
  	<div id="video">
		<iframe width="70%" height="70%" src="https://www.youtube.com/embed/7S0bvcoi5do"  autoplay=1&loop=1&controls=0&rel=0&showinfo=0&playlist=zWAiQJvwb8Q&modestbranding=1" frameborder="0" allowfullscreen="allowfullscreen"></iframe>
	</div>
</center>
</div>
</div>
				...
				<section class="block-a1 pad-tb">
					<div class="container">
						...
						<div class="common-heading">
									...
									<div class="inner-table">
										...
										<div class="details">
											<ul>
												...
												<li><font size="2px">Per transaction limit </font><br>LKR 25,000</li><hr>
												<li><font size="2px">Maximum number of transactions per month </font><br>50</li><hr>
												<li><font size="2px">Monthly Payment Limit</font><br>Below LKR 1 Million / month</li><hr>
												<li><font size="2px">SMS cost per transaction</font><br>LKR 2</li><hr>
												<li>All Solutions<br><font size="2px">Links<br>Plugins<br>APIs<br>SDKs</font></li><hr>
												<li><font size="2px">Payment Charging Methods</font><br>One-time Payments</li><br>&nbsp<hr>
												<li><font size="2px">Customer Support</font><br>General Support</li><br><br><hr>
											</ul>
										</div>
									</div>
							...
							<div class="col-lg-4 col-md-6">
								<div class="pricing-table best-plan mt60 bg-gradient17">
									<div class="inner-table">
										...
										<div class="details">
											<ul>
												<li>LKR 500 <font size="2px">/per month</font></li><hr>
												<li><font size="2px">Per transaction limit </font><br>LKR 50,000</li><hr>
												<li><font size="2px">Maximum number of transactions per month </font><br>100</li><hr>
												<li><font size="2px">Monthly Payment Limit</font><br>Below LKR 2 Million / month</li><hr>
												<li><font size="2px">SMS cost per transaction</font><br>LKR 2</li><hr>
												<li>All Solutions<br><font size="2px">Links<br>Plugins<br>APIs<br>SDKs</font></li><hr>
												<li><font size="2px">Payment Charging Methods</font><br>One-time Payments<br>Recurring Payments<br><font size="2px">(Tokenization fee LKR 5 per card per month)</font></li><hr>
												<li><font size="2px">Customer Support</font><br>General Support<br>Technical Support</li><br><hr>
											</ul>
										</div>
									</div>
							...
							<div class="col-lg-4 col-md-6">
								<div class="pricing-table mt60 bg-gradient4">
									<div class="inner-table">
										...
										<div class="details">
											<ul>
												<li>LKR 750 <font size="2px">/per month</font></li><hr>
												<li><font size="2px">Per transaction limit </font><br>LKR 100,000</li><hr>
												<li><font size="2px">Maximum number of transactions per month </font><br>Unlimited</li><hr>
												<li><font size="2px">Monthly Payment Limit</font><br>Unlimited</li><hr>
												<li><font size="2px">SMS cost per transaction</font><br>LKR 2</li><hr>
												<li>All Solutions<br><font size="2px">Links<br>Plugins<br>APIs<br>SDKs</font></li><hr>
												<li><font size="2px">Payment Charging Methods</font><br>One-time Payments<br>Recurring Payments<br><font size="2px">(Tokenization fee LKR 5 per card per month)</font></li><hr>
												<li><font size="2px">Customer Support</font><br>General Support<br>Technical Support<br>Key Account Manager</li><hr>
											</ul>
										</div>
									</div>
