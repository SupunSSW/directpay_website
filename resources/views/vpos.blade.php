            ...
            <div class="col-lg-6">
                <div class="common-heading-2 text-l">
                    ...
                    <center><h6><br>Transaction History | <font color="#ff822e">Mobile Based Payment Link</font> |
                            ...
                            Transaction Dashboard </h6></center>
                    <br/>
                    <center>
               ...
               ';
                            ...
                            echo '<a href="https://play.google.com/store/apps/details?id=com.directpay.vpos"
                   data-wow-delay=".6s" class="hover-scale mt0 m-mb30"><img src="images/icons/playstore.png" width=32%">
                </a>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <center>
                    <div id="video">
                        <iframe width="70%" height="70%" src="https://www.youtube.com/embed/7S0bvcoi5do"
            ...
            <div class="col-lg-4 col-md-6">
                <div class="pricing-table best-plan mt60">
                    <div class="inner-table">
                        ...
                        <h2> 3.5%</h2>
                        <p class="duration">Payment processing fee<br><font size="2px">(Including bank fees, card
