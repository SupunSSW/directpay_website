        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="blog-header">
                    <h1>The Fintech Revolution Begins in Sri Lanka</h1>
                    <div class="row mt20 mb20">
                        ...
                        <div class="col-md-4 col-3">
                            <div class="postwatch"><i class="far fa-eye"></i> 160</div>
                        </div>
                    </div>
                </div>
                <div class="image-set"><img src="images/blog/blog-post-3.jpg" alt="blog images" class="img-fluid"/>
                </div>
                <div class="blog-content mt30">
                    <p>
                        Cards and mobile wallets have largely failed to challenge the dominance of cash in retail
                    ...
                    <br>
                    <p>
                        The retail space in Sri Lanka will soon be transformed by a revolutionary new concept – JustPay.
                        It is expected to drive the shift from a largely cash-based society to a less cash one. The
                        unique system revolves around the ubiquitous smartphone, leveraging its versatility to usher in
                        a host of benefits across the board – for consumers, merchants, banks, fintech companies and the
                        economy as a whole.
                    </p>
                    <br>
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 mt30 mb30">
                            <div class="blog-post-tag">
                                ...
                                <a href="https://www.echelon.lk/the-fintech-revolution-begins-in-sri-lanka/">Visit
                                    Echelon Article</a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 mt30 mb30">
                            <div class="post-navigation text-left text-md-right">
                                <span><a href="blog3">Next Post</a></span>
            ...
            <div class="col-lg-4">
                <div class="sidebar">
                    ...
                    <div class="offer-image">
                        <img src="images/blog/strategy-guide2.jpg" alt="offer" class="img-fluid"/>
                    </div>
