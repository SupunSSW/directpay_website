...
{{--                    <form id="billing-data" method="POST" action="create2"--}}
                    <form id="billing-data" method="POST" action="{{ route('frontend.accountData.submit') }}"
...
{{--                            <input type="hidden" name="_returnUrl" id="_returnUrl"--}}
{{--                                   value="http://127.0.0.1:8000/consumer">--}}
{{--                            <input type="hidden" name="_cancelUrl" id="_cancelUrl"--}}
{{--                                   value="http://127.0.0.1:8000/consumer">--}}
{{--                            <input type="hidden" name="_responseUrl" id="_responseUrl"--}}
{{--                                   value="http://127.0.0.1:8000/consumer">--}}
{{--                            <input type="hidden" name="_mId" id="_mId" value="--04563">--}}
{{--                            <input type="hidden" name="api_key" id="api_key"--}}
{{--                                   value="94a4b22b6172079f2684acb11cc31ca268ce73e55a77675466722891bb8ba570">--}}

{{--                            <input type="hidden" name="billerCode" id="billerCode"--}}
{{--                                   value="MOB_PO">--}}

                            <div class="col-md-6 form-group" id="container">
                                <input id="_description" type="text" name="_description" placeholder="Account number"
                                       required="required" data-error="Account number is required.">
                                <div class="help-block with-errors"></div>
                            </div>

                            <div class="col-md-6 form-group">
                                <input id="_amount" type="text" name="_amount" placeholder="00.00" required="required"
                                       data-error="Enter Valid Amount." min="20" max="100000" step="1">
                                <div class="help-block with-errors"></div>
                            </div>
                        ...
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="customCheck" name="example1"
                                   required="required">
                            <label class="custom-control-label" for="customCheck">I agree to the <a href="terms"><font
                                        color="#012480">Terms &amp; Conditions</font></a> of DirectPay.</label>
                        </div>
                        ...
                        <p class="trm"><i class="fas fa-lock"></i>By clicking "Checkout" you will be re-directed to the
                            payment options page."</p><br/>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <a class="navbar-brand img-ctr" href="index"><p><font color="#000">Powered by</font></p><img
                                src="images/logo.png" alt="Logo" width="100"/></a><br/>
                        <div class="footer-">
