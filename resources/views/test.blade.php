        ...
        <div class="menu-header">
            ...
            <div class="custom-nav" role="navigation">
                <ul class="nav-list">
                                ...
                                <div class="container">
                                    <div class="sub-menu-center-block">
                                        <div class="sub-menu-column">
                                            <ul>
                                                <li><a href="consumer.php"><font color="#012480"
                                        ...
                                        <div class="sub-menu-column">
                                            <ul>
                                                <li><a href="merchant.php"><font color="#ff822e"
                    ...
                    <li class="sbmenu rpdropdown"><a href="news.blade.php" class="menu-links">NEWS</a></li>
